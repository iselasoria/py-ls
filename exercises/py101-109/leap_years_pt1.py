...
continuous use since since the year 1. We'll address that assumption in the
next exercise that follows this one.
...
- number must be divisible by 400
- divvisible by 100 but not by 400, then NOT a leap year
- number must be divisible by 4 but NOT by 100
