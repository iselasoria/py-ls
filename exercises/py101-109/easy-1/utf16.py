...
Algo:
- initialize an empty list to hold old vars
- iterate over the characters in the string
- get the ord value of each char and append to new list above
- retunr the sum of the ord vals list
"""
...
def utf16_value(str):
    ...
    for char in str:
        ords_list.append(ord(char))

    return sum(ords_list)
