...
and a list of transactions, and returns a list containing only
...
Rules:
- resulting list contains only the transactions for the specific inventory item
...
iterate over the list
    - with every iteration
        - if the id is equal to the inventory item
            - select it
