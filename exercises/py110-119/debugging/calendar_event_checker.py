...
(i.e., no events planned for that date). However, the function always returns
the wrong value.
"""
...
# SOLUTION
# this code is merely checking wether the key exists in the dictionay,
# keys in the dictionary of events indicate dates that are not available so
# instead we need to reverse the logic:
