...
# using the first element of the list numbers ensures you are checking numbers on the list and thus not ognoring the fact that a list might have
# negative numbers as is the case with the last test case